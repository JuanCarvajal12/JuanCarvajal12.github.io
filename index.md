...
<div style="display:flex; gap:32px; align-items:flex-start; flex-wrap:wrap; margin-top:22px;">
  ...
  <div style="flex:0 0 480px; max-width:480px;">
    <img src="/assets/img/pfp_JuanPablo_Carvajal_squared.jpg"
         ...
         style="width:480px; height:480px; object-fit:cover; border-radius:16px; display:block;">
  </div>
  ...
  <div style="flex:1; min-width:280px;">
    ...
    <div style="margin:0 0 1.0rem 0;">
      <p style="margin:0 0 0.6rem 0;">
        I study how <strong>environmental processing transforms dwarf galaxies</strong> as they fall into galaxy clusters.
